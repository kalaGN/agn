...
func (r *RabbitMQ) mqConnect() {
	var err error
	RabbitUrl := fmt.Sprintf("amqp://%v:%v@%v:%v/", config.GetString("rabbitmq.user"), config.GetString("rabbitmq.password"), config.GetString("rabbitmq.ip"), config.GetString("rabbitmq.port"))
